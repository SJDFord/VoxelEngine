...
void VoxelRenderer::render(const Shader& shader, const ICamera& camera, const VoxelContainerGeometry& chunkGeometry, const ILightSource& light, glm::mat4 modelMatrix) const
{
	if (chunkGeometry.needsRendering())
	{
		glBindVertexArray(_vertexArrayId);
