...
int main(int argc, char** argv) {
	...
	std::shared_ptr<ImageSourceChunkFactory> chunkFactory = std::make_shared<ImageSourceChunkFactory>(".\\vatican.bmp", false, false);
...
bool setupEnvironment(GLFWwindow*& window)
{
	...
	window = glfwCreateWindow(1024 * 2, 768 * 2, "Photo Height Map", nullptr, nullptr);
	if (window == nullptr) {
